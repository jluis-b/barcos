...
public class BarcoMercante extends Barco {
	...
	/**
	 *  Metodo que calcula el valor economico que tendra el barco en 10 a�os, segun el valor economico multiplicado por  la ra�z cuadrada del n�mero de a�os que tendr� dentro de 10 a�os.
	 */
	@Override
